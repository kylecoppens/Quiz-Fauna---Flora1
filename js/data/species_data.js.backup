...
,
  ...
  // ── 12 nieuwe plantensoorten (lokale afbeeldingen) ─────────────────────

  {
    ...
    habitat: { nl: "Ruderale terreinen, wegbermen, bosranden, rivieroevers", en: "Waste ground, roadsides, woodland edges, riverbanks", fr: "Terrains vagues, bords de routes, lisières, berges" },
    rarity: { nl: "Algemeen in heel België", en: "Common throughout Belgium", fr: "Commun dans toute la Belgique" },
    description: { nl: "Een forse tweejarige plant die tot 2 m hoog kan worden. De grote, hartvormige bladeren en kleverige bloemhoofdjes met haakjes zijn kenmerkend. De haakjes inspireerden de uitvinding van klittenband.", en: "A robust biennial reaching up to 2 m. Recognised by its large heart-shaped leaves and sticky flower heads with hooked bracts. These hooks inspired the invention of Velcro.", fr: "Bisannuelle robuste pouvant atteindre 2 m. Reconnaissable à ses grandes feuilles cordiformes et ses capitules à bractées crochues, qui ont inspiré l'invention du Velcro." },
    size: { nl: "100–200 cm hoog", en: "100–200 cm tall", fr: "100–200 cm de hauteur" },
    diet: { nl: "Fotosynthese", en: "Photosynthesis", fr: "Photosynthèse" },
    image: "assets/images/arctium_lappa_flora.jpg",
    funfact: { nl: "De Zwitserse ingenieur Georges de Mestral bedacht klittenband nadat hij klitvruchten uit zijn hondenvacht plukte.", en: "Swiss engineer Georges de Mestral invented Velcro after picking burdock burrs off his dog's fur.", fr: "L'ingénieur suisse Georges de Mestral a inventé le Velcro après avoir retiré des fruits de bardane de la fourrure de son chien." }
  },
  {
    id: "arctium_minus",
    ...
    habitat: { nl: "Wegbermen, braakliggende gronden, heggen, bosranden", en: "Roadsides, waste ground, hedgerows, woodland edges", fr: "Bords de routes, friches, haies, lisières" },
    rarity: { nl: "Zeer algemeen in België", en: "Very common in Belgium", fr: "Très commun en Belgique" },
    description: { nl: "Lijkt op de grote klit maar is kleiner en compacter. De bloemhoofdjes zijn minder groot en de bladeren smaller. Groeit vaak op verstoorde bodems en langs paden.", en: "Resembles greater burdock but is smaller and more compact. Flower heads are smaller and leaves narrower. Often found on disturbed soils and along paths.", fr: "Ressemble à la grande bardane mais plus petite et compacte. Capitules plus petits et feuilles plus étroites. Souvent sur sols perturbés et le long des sentiers." },
    size: { nl: "50–120 cm hoog", en: "50–120 cm tall", fr: "50–120 cm de hauteur" },
    diet: { nl: "Fotosynthese", en: "Photosynthesis", fr: "Photosynthèse" },
    image: "assets/images/arctium_minus_flora.jpg",
    funfact: { nl: "De wortel van de klit wordt in Japan gegeten als groente, bekend als 'gobo'.", en: "The root of burdock is eaten in Japan as a vegetable called 'gobo'.", fr: "La racine de la bardane est consommée au Japon comme légume appelé 'gobo'." }
  },
  {
    ...
    iucn: "LC",
    plantGrade: "dicot",
    name: { nl: "Eenstijlige meidoorn", en: "Common Hawthorn", fr: "Aubépine monogyne" },
    habitat: { nl: "Heggen, bosranden, kalkgraslanden, struwelen", en: "Hedgerows, woodland edges, chalk grasslands, scrub", fr: "Haies, lisières, pelouses calcaires, fourrés" },
    rarity: { nl: "Zeer algemeen in heel België", en: "Very common throughout Belgium", fr: "Très commun dans toute la Belgique" },
    description: { nl: "Een doornige struik of kleine boom met diep ingesneden bladeren en witte bloemen in mei. De donkerrode bessen (meidoornappeltjes) zijn belangrijk voedsel voor vogels in de herfst.", en: "A thorny shrub or small tree with deeply lobed leaves and white flowers in May. The dark red berries (haws) are important bird food in autumn.", fr: "Arbuste épineux ou petit arbre aux feuilles profondément lobées et fleurs blanches en mai. Les fruits rouges foncés (cenelles) sont importants pour les oiseaux en automne." },
    size: { nl: "2–10 m hoog", en: "2–10 m tall", fr: "2–10 m de hauteur" },
    diet: { nl: "Fotosynthese", en: "Photosynthesis", fr: "Photosynthèse" },
    image: "assets/images/crataegus_monogyna_flora.jpg",
    funfact: { nl: "Meidoornheggen in Engeland kunnen honderden jaren oud zijn en werden al in de Middeleeuwen als perceelafscheiding geplant.", en: "Hawthorn hedges in England can be hundreds of years old, planted as field boundaries since the Middle Ages.", fr: "Les haies d'aubépine en Angleterre peuvent avoir des centaines d'années, plantées comme clôtures depuis le Moyen Âge." }
  },
  {
    ...
    iucn: "LC",
    plantGrade: "dicot",
    name: { nl: "Grote kaardebol", en: "Wild Teasel", fr: "Cardère sauvage" },
    habitat: { nl: "Wegbermen, braakliggende terreinen, oevers, kleigrond", en: "Roadsides, waste ground, riverbanks, clay soils", fr: "Bords de routes, friches, berges, sols argileux" },
    rarity: { nl: "Vrij algemeen, vooral in Midden- en Laag-België", en: "Fairly common, especially in Mid and Low Belgium", fr: "Assez commun, surtout en Moyenne et Basse Belgique" },
    description: { nl: "Opvallende tweejarige plant met stekelige stengels en eironde bloemhoofdjes die van onder naar boven openbloeien met een ring van lila bloemen. De gedroogde bloemhoofdjes werden vroeger gebruikt om wol te kaarden.", en: "Striking biennial with prickly stems and egg-shaped flower heads that bloom from bottom to top with a ring of lilac flowers. Dried heads were once used for carding wool.", fr: "Bisannuelle frappante aux tiges épineuses et capitules ovoïdes qui fleurissent de bas en haut avec un anneau de fleurs lilas. Les capitules séchés servaient autrefois à carder la laine." },
    size: { nl: "100–200 cm hoog", en: "100–200 cm tall", fr: "100–200 cm de hauteur" },
    diet: { nl: "Fotosynthese", en: "Photosynthesis", fr: "Photosynthèse" },
    image: "assets/images/dipsacus_fullonum_flora.jpg",
    funfact: { nl: "Regenwater verzamelt zich in de bekervormen die de tegenoverstaande bladeren vormen rond de stengel — een val voor insecten.", en: "Rainwater collects in the cup-shaped reservoirs formed where opposite leaves meet the stem — a trap for insects.", fr: "L'eau de pluie s'accumule dans les réservoirs en coupe formés par les feuilles opposées autour de la tige — un piège pour les insectes." }
  },
  {
    id: "echium_vulgare",
    ...
    habitat: { nl: "Droge, zandige gronden, dijken, spoorwegtaluds, kalkgraslanden", en: "Dry sandy soils, embankments, railway cuttings, chalk grasslands", fr: "Sols secs et sablonneux, digues, talus ferroviaires, pelouses calcaires" },
    rarity: { nl: "Vrij algemeen, vooral op droge standplaatsen", en: "Fairly common, especially on dry sites", fr: "Assez commun, surtout sur sites secs" },
    description: { nl: "Spectaculaire plant met felblauwe, trechtervormige bloemen aan een opvallende, dicht behaarde bloeiwijze. De knoppen zijn roze en verkleuren naar blauw bij het opengaan. Uitstekende bijenplant.", en: "Spectacular plant with bright blue funnel-shaped flowers on a striking, densely hairy inflorescence. Buds are pink, turning blue as they open. Excellent bee plant.", fr: "Plante spectaculaire aux fleurs bleu vif en entonnoir sur une inflorescence frappante et densément poilue. Boutons roses virant au bleu à l'ouverture. Excellente plante mellifère." },
    size: { nl: "30–90 cm hoog", en: "30–90 cm tall", fr: "30–90 cm de hauteur" },
    diet: { nl: "Fotosynthese", en: "Photosynthesis", fr: "Photosynthèse" },
    image: "assets/images/echium_vulgare_flora.jpg",
    funfact: { nl: "De naam 'slangenkruid' komt van de gespleten stamper die lijkt op een slangentong. Vroeger werd het als middel tegen slangenbeten gebruikt.", en: "The name 'viper's bugloss' comes from the forked stigma resembling a snake's tongue. It was once used as a remedy for snakebites.", fr: "Le nom 'vipérine' vient du stigmate fourchu rappelant la langue d'un serpent. Autrefois utilisée comme remède contre les morsures de vipère." }
  },
  {
    id: "hedera_helix",
    ...
    iucn: "LC",
    plantGrade: "dicot",
    name: { nl: "Klimop", en: "Common Ivy", fr: "Lierre grimpant" },
    habitat: { nl: "Bossen, muren, bomen, rotsen, tuinen", en: "Woodlands, walls, trees, rocks, gardens", fr: "Forêts, murs, arbres, rochers, jardins" },
    rarity: { nl: "Zeer algemeen in heel België", en: "Very common throughout Belgium", fr: "Très commun dans toute la Belgique" },
    description: { nl: "Een groenblijvende klimplant die met hechtwortels op bomen, muren en rotsen groeit. De bladeren zijn op jonge scheuten handvormig, maar worden ruitvormig op bloeiende takken. Bloeit laat in de herfst en is dan cruciaal voor bijen.", en: "An evergreen climber that clings to trees, walls and rocks with aerial rootlets. Leaves are palmate on young shoots but become diamond-shaped on flowering branches. Flowers late in autumn, crucial for bees.", fr: "Plante grimpante sempervirente qui s'accroche aux arbres, murs et rochers par des crampons. Feuilles palmées sur les jeunes pousses, devenant losangiques sur les branches fleuries. Fleurit tard en automne, cruciale pour les abeilles." },
    size: { nl: "Klimt tot 30 m hoog", en: "Climbs up to 30 m", fr: "Grimpe jusqu'à 30 m" },
    diet: { nl: "Fotosynthese", en: "Photosynthesis", fr: "Photosynthèse" },
    image: "assets/images/hedera_helix_flora.jpg",
    funfact: { nl: "Klimop is een van de weinige planten die in de herfst bloeit en zo nectar levert als bijna alle andere bloemen al uitgebloeid zijn.", en: "Ivy is one of the few plants that flowers in autumn, providing nectar when almost all other flowers have finished.", fr: "Le lierre est l'une des rares plantes qui fleurit en automne, fournissant du nectar quand presque toutes les autres fleurs sont fanées." }
  },
  {
    ...
    habitat: { nl: "Graslanden, wegbermen, braakland, akkerranden", en: "Grasslands, roadsides, waste ground, field margins", fr: "Prairies, bords de routes, friches, bordures de champs" },
    rarity: { nl: "Zeer algemeen in heel België", en: "Very common throughout Belgium", fr: "Très commun dans toute la Belgique" },
    description: { nl: "Klein, laagblijvend vlinderbloemig plantje met drietallige blaadjes en kleine, bolronde gele bloemhoofdjes. Wordt vaak verward met klaver. De peultjes worden zwart bij rijpheid, wat de Engelse naam verklaart.", en: "Small, low-growing legume with trifoliate leaves and small, globular yellow flower heads. Often confused with clover. The seed pods turn black when ripe, explaining the English name.", fr: "Petite légumineuse rampante à feuilles trifoliées et petits capitules globuleux jaunes. Souvent confondue avec le trèfle. Les gousses noircissent à maturité, d'où le nom anglais." },
    ...
    funfact: { nl: "Als vlinderbloemige kan hopklaver stikstof uit de lucht binden dankzij een samenwerking met Rhizobium-bacteriën in wortelknolletjes.", en: "As a legume, black medick can fix atmospheric nitrogen through symbiosis with Rhizobium bacteria in root nodules.", fr: "En tant que légumineuse, la luzerne lupuline fixe l'azote atmosphérique grâce à sa symbiose avec les bactéries Rhizobium dans ses nodules racinaires." }
  },
  {
    ...
    habitat: { nl: "Graslanden, wegbermen, gazons, akkerranden", en: "Grasslands, roadsides, lawns, field margins", fr: "Prairies, bords de routes, pelouses, bordures de champs" },
    rarity: { nl: "Zeer algemeen in heel België", en: "Very common throughout Belgium", fr: "Très commun dans toute la Belgique" },
    description: { nl: "Onopvallende maar alomtegenwoordige plant met lancetvormige bladeren in een rozet en bruine bloemaren op lange stengels. Kinderen gebruiken de bloemstengels als 'soldaatje' in een oud spelletje.", en: "Inconspicuous but ubiquitous plant with lance-shaped leaves in a rosette and brown flower spikes on long stems. Children use the flower stems in a traditional 'soldier' game.", fr: "Plante discrète mais omniprésente, à feuilles lancéolées en rosette et épis bruns sur de longues tiges. Les enfants utilisent les tiges florales dans un jeu traditionnel de 'soldat'." },
    size: { nl: "10–50 cm hoog", en: "10–50 cm tall", fr: "10–50 cm de hauteur" },
    diet: { nl: "Fotosynthese", en: "Photosynthesis", fr: "Photosynthèse" },
    image: "assets/images/plantago_lanceolata_flora.jpg",
    funfact: { nl: "Smalle weegbree was een traditioneel geneeskruid: verfrommelde bladeren op een insectenbeet leggen verlicht de jeuk.", en: "Ribwort plantain was a traditional remedy: crushed leaves placed on insect bites relieve itching.", fr: "Le plantain lancéolé était un remède traditionnel : des feuilles froissées appliquées sur une piqûre d'insecte soulagent les démangeaisons." }
  },
  {
    id: "reseda_luteola",
    ...
    iucn: "LC",
    plantGrade: "dicot",
    name: { nl: "Wouw", en: "Weld", fr: "Réséda des teinturiers" },
    habitat: { nl: "Droge, kalkrijke gronden, muren, spoorwegterreinen, braakland", en: "Dry calcareous soils, walls, railway land, waste ground", fr: "Sols secs calcaires, murs, terrains ferroviaires, friches" },
    rarity: { nl: "Vrij zeldzaam, vooral in kalkrijke regio's", en: "Fairly rare, mainly in calcareous regions", fr: "Assez rare, surtout dans les régions calcaires" },
    description: { nl: "Slanke tweejarige plant met een lange, smalle tros van geelgroene bloemetjes en spatelvormige bladeren. Was eeuwenlang de belangrijkste bron van gele kleurstof in Europa.", en: "Slender biennial with a long, narrow spike of yellow-green flowers and spatulate leaves. For centuries it was Europe's most important source of yellow dye.", fr: "Bisannuelle élancée à long épi étroit de petites fleurs jaune-vert et feuilles spatulées. Pendant des siècles, la principale source de teinture jaune en Europe." },
    size: { nl: "50–150 cm hoog", en: "50–150 cm tall", fr: "50–150 cm de hauteur" },
    diet: { nl: "Fotosynthese", en: "Photosynthesis", fr: "Photosynthèse" },
    image: "assets/images/reseda_luteola_flora.jpg",
    funfact: { nl: "Wouw werd al door de Romeinen gebruikt als verfplant. De gele kleurstof luteoline is lichtecht en werd tot in de 19e eeuw gebruikt.", en: "Weld was used by the Romans as a dye plant. Its yellow pigment luteolin is lightfast and was used until the 19th century.", fr: "Le réséda des teinturiers était utilisé par les Romains. Son pigment jaune, la lutéoline, résiste à la lumière et fut utilisé jusqu'au 19e siècle." }
  },
  {
    id: "salix_caprea",
    ...
    habitat: { nl: "Bosranden, kapvlakten, heggen, vochtige gronden", en: "Woodland edges, clearings, hedgerows, damp soils", fr: "Lisières, clairières, haies, sols humides" },
    rarity: { nl: "Zeer algemeen in heel België", en: "Very common throughout Belgium", fr: "Très commun dans toute la Belgique" },
    description: { nl: "Een snelgroeiende boom of grote struik, bekend om de zachte, zilverachtige katjes ('palmtakken') die al vroeg in het voorjaar verschijnen. Een van de eerste voedselbronnen voor bijen na de winter.", en: "A fast-growing tree or large shrub, known for its soft silvery catkins ('pussy willows') that appear early in spring. One of the first food sources for bees after winter.", fr: "Arbre ou grand arbuste à croissance rapide, connu pour ses chatons argentés et soyeux qui apparaissent tôt au printemps. L'une des premières sources de nourriture pour les abeilles après l'hiver." },
    size: { nl: "6–12 m hoog", en: "6–12 m tall", fr: "6–12 m de hauteur" },
    diet: { nl: "Fotosynthese", en: "Photosynthesis", fr: "Photosynthèse" },
    image: "assets/images/salix_caprea_trees.jpg",
    funfact: { nl: "De katjes van de boswilg worden in België traditioneel op Palmzondag gezegend en als 'palmtakken' gebruikt.", en: "Goat willow catkins are traditionally blessed on Palm Sunday in Belgium and used as 'palm branches'.", fr: "Les chatons du saule marsault sont traditionnellement bénis le dimanche des Rameaux en Belgique et utilisés comme 'rameaux'." }
  },
  {
    ...
    iucn: "LC",
    plantGrade: "dicot",
    name: { nl: "Echte koekoeksbloem", en: "Ragged Robin", fr: "Silène fleur-de-coucou" },
    habitat: { nl: "Vochtige graslanden, hooilanden, slootkanten, moerassen", en: "Wet meadows, hay meadows, ditch banks, marshes", fr: "Prairies humides, prairies de fauche, bords de fossés, marais" },
    rarity: { nl: "Vrij algemeen, afnemend door verdroging", en: "Fairly common, declining due to drainage", fr: "Assez commun, en déclin à cause du drainage" },
    description: { nl: "Sierlijke plant met opvallende roze bloemen waarvan de kroonbladen diep ingesneden zijn in vier smalle slippen, wat een 'gerafeld' uiterlijk geeft. Bloeit in mei-juni in vochtige weilanden.", en: "Graceful plant with striking pink flowers whose petals are deeply divided into four narrow lobes, giving a 'ragged' appearance. Flowers May–June in wet meadows.", fr: "Plante gracieuse aux fleurs roses frappantes dont les pétales sont profondément divisés en quatre lobes étroits, donnant un aspect 'déchiqueté'. Floraison mai–juin dans les prairies humides." },
    size: { nl: "30–75 cm hoog", en: "30–75 cm tall", fr: "30–75 cm de hauteur" },
    diet: { nl: "Fotosynthese", en: "Photosynthesis", fr: "Photosynthèse" },
    image: "assets/images/silene_flos-cuculi_flora.jpg",
    funfact: { nl: "De naam 'koekoeksbloem' verwijst naar het feit dat de plant bloeit wanneer de koekoek begint te roepen.", en: "The name 'cuckoo flower' refers to the plant blooming when the cuckoo starts calling.", fr: "Le nom 'fleur-de-coucou' fait référence au fait que la plante fleurit quand le coucou commence à chanter." }
  },
  {
    id: "tilia_tomentosa",
    ...
    habitat: { nl: "Parken, lanen, tuinen, stedelijke beplanting", en: "Parks, avenues, gardens, urban planting", fr: "Parcs, avenues, jardins, plantations urbaines" },
    rarity: { nl: "Aangeplant, algemeen als laanboom", en: "Planted, common as avenue tree", fr: "Planté, commun comme arbre d'alignement" },
    description: { nl: "Grote, statige boom met hartvormige bladeren die aan de onderzijde dicht zilvergrijs behaard zijn. Bloeit in juli met geurige bloemen. Populaire laanboom in Belgische steden door tolerantie voor droogte en vervuiling.", en: "Large, stately tree with heart-shaped leaves densely silver-grey hairy beneath. Flowers in July with fragrant blossoms. Popular avenue tree in Belgian cities due to drought and pollution tolerance.", fr: "Grand arbre majestueux aux feuilles cordiformes densément argentées-grises dessous. Floraison en juillet avec des fleurs parfumées. Arbre d'alignement populaire en Belgique pour sa tolérance à la sécheresse et la pollution." },
    size: { nl: "20–30 m hoog", en: "20–30 m tall", fr: "20–30 m de hauteur" },
    diet: { nl: "Fotosynthese", en: "Photosynthesis", fr: "Photosynthèse" },
    image: "assets/images/tilia_tomentosa_trees.jpg",
    funfact: { nl: "De nectar van de zilverlinde kan verdovend werken op hommels — je vindt ze soms verdwaasd onder de boom.", en: "Silver lime nectar can have a narcotic effect on bumblebees — you sometimes find them dazed under the tree.", fr: "Le nectar du tilleul argenté peut avoir un effet narcotique sur les bourdons — on les trouve parfois étourdis sous l'arbre." }
  }
];
